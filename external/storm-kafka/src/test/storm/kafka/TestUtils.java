...
public class TestUtils {
    ...
    public static void createTopicAndSendMessage(KafkaTestBroker broker, String topic) {
        createTopicAndSendMessage(broker, topic, null, "someValue");
    }

    public static void createTopicAndSendMessage(KafkaTestBroker broker, String topic, String value) {
        createTopicAndSendMessage(broker, topic, null, value);
    }
